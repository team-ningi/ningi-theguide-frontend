...
// const question =
// "Client 1 is Tony Cervi aka Antonio Cervi, I want to find out his personal information, all of the information i wish to know are inside this example JSON payload { title: client 1s title, other_title: client 1s other titles, first_name: client 1s first name, middle_name: client 1s middle name, last_name: client 1s last name , salutation: client 1s salutation, dob: client 1s date of birth, age: client 1s age, gender: client 1s gender, marital_status: client 1s marital status , date_of_marriage:client 1s date of marriage, nationality: client 1s nationality, national_insurance_number: client 1s national insurance number, country_of_residence:client 1s country of residence, domicile:  client 1s country of domicile, expatriate: client 1s expatriate ,country_of_birth: client 1s country of birth, place_of_birth:client 1s place of birth, valid_will_in_place: does client 1 have a valid will in place, will_upto_date: Is client 1s will upto date, advised_to_make_a_will:has client 1 been advised to make a will, power_of_attorney:has client 1 granted a power of attorney, attorney_name:what is client 1s attorney name, smoker: is client 1 a smoker, smoked_in_12months:has client 1 smoked in last 12 months, in_good_health: is client 1 in good health } . Please only return this JSON object but with the values replaced with the correct data";
